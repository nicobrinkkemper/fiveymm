...
const getLinkTags = ({ path }: getLinkTagsProps) => [
  ...
  },
  {
    rel: "apple-touch-icon",
    sizes: "57x57",
    href: `${absoluteUrl(path)}/apple-icon-57x57.png`,
  },
  {
    rel: "apple-touch-icon",
    sizes: "60x60",
    href: `${absoluteUrl(path)}/apple-icon-60x60.png`,
  },
  {
    rel: "apple-touch-icon",
    sizes: "72x72",
    href: `${absoluteUrl(path)}/apple-icon-72x72.png`,
  },
  {
    rel: "apple-touch-icon",
    sizes: "76x76",
    href: `${absoluteUrl(path)}/apple-icon-76x76.png`,
  },
  {
    rel: "apple-touch-icon",
    sizes: "114x114",
    href: `${absoluteUrl(path)}/apple-icon-114x114.png`,
  },
  {
    rel: "apple-touch-icon",
    sizes: "120x120",
    href: `${absoluteUrl(path)}/apple-icon-120x120.png`,
  },
  {
    rel: "apple-touch-icon",
    sizes: "144x144",
    href: `${absoluteUrl(path)}/apple-icon-144x144.png`,
  },
  {
    rel: "apple-touch-icon",
    sizes: "152x152",
    href: `${absoluteUrl(path)}/apple-icon-152x152.png`,
  },
  {
    rel: "apple-touch-icon",
    sizes: "180x180",
    href: `${absoluteUrl(path)}/apple-icon-180x180.png`,
  },
  {
    rel: "apple-touch-icon-precomposed",
    sizes: "180x180",
    href: `${absoluteUrl(path)}/apple-touch-icon-precomposed.png`,
  },
  {
